...
*/
/** Kafka messaging configuration class
 *
...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, ScheduleDTO> CarProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, ScheduleDTO> carafkaTemplate() {
